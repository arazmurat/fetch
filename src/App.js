...
const UserInfo = ({ match }) => {
  ...
  return (
    <h1>
      User Info Page Name: {match.params.name} Age: {match.params.age}
    </h1>
  );
};
    ...
    return (
      <BrowserRouter>
        <div className="App">
          ...
          <NavLink activeClassName="activeClass" to="/AboutPage/333">
            About-333
          </NavLink>{" "}
          <br />
          <NavLink activeClassName="activeClass" to="/Users">
            User List
          </NavLink>
          <br />
          <NavLink activeClassName="activeClass" to="/Profile">
            Profile
          </NavLink>{" "}
          <br />
          <input
